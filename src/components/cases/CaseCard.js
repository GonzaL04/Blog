                ...
                <div className="flex flex-1 flex-col justify-between bg-white p-6">
                  <div className="flex-1">
                    ...
                    <a href={data.href} className="mt-2 block">
                      <p id={index} className="lg:text-3xl text-2xl pt-4 pb-6 font-semibold transition duration-400 ease-in-out text-gray-900">{data.title}</p>
                      <p className="mt-3 text-1xl leading-9 text-gray-500">{data.description}</p>
                    </a>
                  </div>
                </div>
        </Link>
