...
function ServicesCard({data, index}){
    return(
        ...
        className="w-full relative p-8 h-96 lg:h-[200pm] bg-white shadow-xl hover:-translate-y-1 transition duration-300 ease-in-out">
            ...
            <div className="absolute bottom-0 left-0 p-8">
                <h2 id={index} className="items-end text-xl text-gray-900 font-semibold pt-8">Learn More</h2>
            </div>
        </div>
    )
}
