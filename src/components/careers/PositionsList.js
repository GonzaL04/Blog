...
function PositionsList(){
    return(
        <div className="max-w-full mx-12 bg-white">
            ...
            <p className="text-1xl font-regular text-gray-900 max-w-5xl">
            At the beginning at least, but then we realized we could make a lot more money if we kinda stopped caring
            about that. Our new strategy is to write a bunch of things that look really good in the headlines.
            </p>
