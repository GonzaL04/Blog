...
import code_img from 'assets/img/services/code.png'
import secure_img from 'assets/img/services/secure.png'
import conduct_img from 'assets/img/services/conduct.png'
...
const posts_desing = [
    ...
    {
      title: 'La T el mas grande del interior',
      img: conduct_img,
      href: '#',
      category: { name: 'Case Study', href: '#' },
      description:
